...
export function setupDrawing(virtualMirror) {
	"use strict";

	var drawing			= virtualMirror.drawing;
	...
	if(drawing.setup && !drawing.stage) {
		drawing.setup(document.getElementById("_drawing"), document.getElementById("_faceSub"), 30);
	}
};

import { initThreeJS } from './ThreeJS_example'
...
var brfv4BaseURL = _isWebAssemblySupported ? "assets/libs/brf_wasm/" : "assets/libs/brf_asmjs/";
...
function initVirtualMirror(arModel) {
  ...
  function trackFaces() {
    ...
    if(virtualMirror.stats.start) virtualMirror.stats.start();
    ...
    // if(virtualMirror.stats.end) virtualMirror.stats.end();

(function() {
	...
	if(!virtualMirror.gui.downloadChooser) {

		QuickSettings.useExtStyleSheet();

		virtualMirror.gui.downloadChooser = QuickSettings.create(
			2, 270, "Useful links", virtualMirror.dom.createDiv("_settingsRight"))
			.setWidth(250)

(function exampleCode() {
	...
	virtualMirror.initCurrentExample = function(brfManager, resolution, draw) {
	...
	virtualMirror.updateCurrentExample = function(brfManager, imageData, draw) {
		...
		if(points.length !== _numTrackedPoints) {
			...
			virtualMirror.dom.updateHeadline("BRFv4 - Basic - Point Tracking\n" +
	...
	virtualMirror.dom.updateHeadline("BRFv4 - basic - point tracking - track points and a face.\n" +

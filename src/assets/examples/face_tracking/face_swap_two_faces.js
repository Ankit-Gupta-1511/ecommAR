(function exampleCode() {
	...
	var _extractedFace0 = virtualMirror.dom.createCanvas("_extractedFace0", _size, _size, null);
	var _extractedFace1 = virtualMirror.dom.createCanvas("_extractedFace1", _size, _size, null);
	...
	var _imageData = virtualMirror.dom.getElement("_imageData");
	...
	virtualMirror.updateCurrentExample = function(brfManager, imageData, draw) {
	...
	virtualMirror.dom.updateHeadline("BRFv4 - advanced - face swap of two faces.\n" +
		"Switch faces with a friend.");

	virtualMirror.dom.updateCodeSnippet(exampleCode + "");
})();
(function exampleCode() {
	...
	virtualMirror.updateCurrentExample = function(brfManager, imageData, draw) {
		...
		for(var i = 0; i < faces.length; i++) {
			...
			if(		face.state === brfv4.BRFState.FACE_TRACKING_START ||
				...
				virtualMirror.dom.updateHeadline("BRFv4 - Advanced - A Simple Yawn Detection.\n" +
	...
	virtualMirror.dom.updateHeadline("BRFv4 - intermediate - face tracking - simple yawn detection.\n" +

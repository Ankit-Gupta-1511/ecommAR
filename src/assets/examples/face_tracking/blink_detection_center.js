(function exampleCode() {
  ...
  var _faceDetectionRoi = new brfv4.Rectangle();
    ...
    brfManager.init(resolution, _faceDetectionRoi, virtualMirror.appId);
    ...
    draw.drawRect(_faceDetectionRoi,					false, 2.0, 0x8aff00, 0.5);
		...
		for(var i = 0; i < faces.length; i++) {
			...
			if(face.state === brfv4.BRFState.FACE_TRACKING) {
				...
				virtualMirror.dom.updateHeadline("BRFv4 - advanced - face tracking - simple blink" +
	...
	virtualMirror.dom.updateHeadline("BRFv4 - advanced - face tracking - simple blink detection.\n" +

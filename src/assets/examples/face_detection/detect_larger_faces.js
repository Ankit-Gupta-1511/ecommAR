(function exampleCode() {
	...
	function printSize(rects, printAlwaysMinMax) {
		...
		if(maxWidth > 0) {
			...
			virtualMirror.dom.updateHeadline("BRFv4 - basic - face detection - detect large " +
				"faces\nCome closer to the webcam to see detection results. " + str);
		}
	}

	virtualMirror.dom.updateHeadline("BRFv4 - basic - face detection - detect large faces\n" +
